...
export default defineConfig({
  resolve: {
    alias: [
      ...
      { find: "@agent-os/kernel/effect-claim", replacement: file("../kernel/src/effect-claim.ts") },
      { find: "@agent-os/kernel/material-ref", replacement: file("../kernel/src/material-ref.ts") },
      { find: "@agent-os/kernel/ref-resolver", replacement: file("../kernel/src/ref-resolver.ts") },
