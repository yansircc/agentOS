<!-- generated by tooling/agentos-cli/src/generate/generate-docs.mjs; edit docs/surface.json and docs/api/resource-carrier.md -->

# @agent-os/resource-carrier Public API

Status: 0.5.x active development for provider-neutral resource carrier algebra. Public exports are listed for accidental export control only; this is not an API freeze.
