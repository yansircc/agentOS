<!-- generated by tooling/agentos-cli/src/generate/generate-docs.mjs; edit docs/surface.json and docs/api/workspace-op.md -->

# @agent-os/workspace-op Public API

Status: 0.5.x active development for provider-neutral workspace operation carrier algebra. Public exports are listed for accidental export control only; this is not an API freeze.
