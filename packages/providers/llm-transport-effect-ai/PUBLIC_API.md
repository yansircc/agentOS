<!-- generated by tooling/agentos-cli/src/generate/generate-docs.mjs; edit docs/surface.json and docs/api/llm-transport-effect-ai.md -->

# @agent-os/llm-transport-effect-ai Public API

Status: 0.5.x public-experimental. Effect AI remains a provider projection layer and does not own runtime facts.
