<!-- generated by tooling/agentos-cli/src/generate/generate-docs.mjs; edit docs/surface.json and docs/packages/workspace-env-cloudflare.md -->
...
0.5.x active development. Provider-specific exports are listed in `PUBLIC_API.md`; this is not an API freeze.
