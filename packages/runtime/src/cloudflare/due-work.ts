...
const SQLITE_DUE_WORK_CONSTRAINTS = [
  { name: "due_work_kind_nonempty", definition: "CHECK (kind <> '')" },
  {
    ...
    definition: `CHECK (
      fire_at BETWEEN -1.7976931348623157e308 AND 1.7976931348623157e308
      AND (completed_at IS NULL OR completed_at BETWEEN -1.7976931348623157e308 AND 1.7976931348623157e308)
