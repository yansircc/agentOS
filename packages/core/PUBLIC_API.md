<!-- generated by packages/cli/src/generate/generate-docs.mjs; edit docs/surface.json and docs/api/core.md -->

# @agent-os/core Public API

Status: 0.6.x active development. Public exports are listed for accidental export control only; this is not an API freeze.
...
- `.:LlmProviderContinuationBindingSchema`
...
- `./authored-value:AuthoredValue`
- `./backend-protocol:BACKEND_CONFORMANCE_CAPABILITY`
- `./backend-protocol:BACKEND_CONFORMANCE_LAWS`
- `./backend-protocol:BACKEND_CONFORMANCE_LAW_ID`
...
- `./backend-protocol:BackendConformanceIssue`
- `./backend-protocol:BackendConformanceLaw`
- `./backend-protocol:BackendConformanceLawId`
- `./backend-protocol:BackendConformanceLawResult`
...
- `./backend-protocol:validateBackendConformanceReport`
...
- `./llm-protocol:LlmProviderContinuation`
- `./llm-protocol:LlmProviderContinuationBinding`
- `./llm-protocol:LlmProviderContinuationBindingSchema`
- `./llm-protocol:LlmProviderContinuationCallContext`
- `./llm-protocol:LlmProviderContinuationFailure`
- `./llm-protocol:LlmProviderContinuationJson`
- `./llm-protocol:LlmProviderContinuationMarker`
- `./llm-protocol:LlmProviderContinuationMarkerSchema`
- `./llm-protocol:LlmProviderContinuationStore`
- `./llm-protocol:LlmProviderContinuationStoreNone`
- `./llm-protocol:LlmProviderContinuationTurn`
- `./llm-protocol:LlmRecordedResponse`
- `./llm-protocol:LlmRequest`
- `./llm-protocol:LlmResponse`
- `./llm-protocol:LlmResponseContinuation`
- `./llm-protocol:LlmRoute`
- `./llm-protocol:llmRouteFingerprint`
...
- `./llm-protocol:markerFromProviderContinuation`
...
- `./llm-protocol:validateProviderContinuationBinding`
