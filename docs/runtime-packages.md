...
| `@agent-os/runtime`                      | yes       | 0.2.x public           | backend-neutral runtime Tag contracts, service implementations, projections, trigger registry contracts, and trigger authoring types |
...
| `@agent-os/workspace-job`                | yes       | carrier                | workspace job request, finalized terminal artifact metadata, verifier verdict, structured failure, and projection vocabulary         |
