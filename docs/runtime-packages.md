...
| `@agent-os/evals`     | yes       | 0.5.x public | DSL-only public authoring surface. It declares evals, datasets, symbolic provider needs, public-client context facades, and assertion intent; it must not assemble runtime graphs, construct model providers, serve generated apps, import runtime internals, or treat eval result artifacts as source facts.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
