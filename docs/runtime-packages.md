...
| `@agent-os/ag-ui-react`                  | yes       | retired by client package migration | retired framework binding; @agent-os/client-react becomes the only React bridge                                                                                               |
| `@agent-os/ag-ui-svelte`                 | yes       | retired by client package migration | retired framework binding; @agent-os/client-svelte becomes the only Svelte bridge                                                                                             |
