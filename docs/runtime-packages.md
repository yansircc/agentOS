...
| ---------------------------------------- | --------- | ---------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `@agent-os/kernel`                       | yes       | 0.4.x public           | platform-free claim/material/boundary/AgentSchema/tool algebra plus raw JSON Schema dialect for non-LLM boundaries                                                            |
| `@agent-os/runtime`                      | yes       | 0.4.x public           | backend-neutral runtime Tag contracts, service implementations, projections, cross-carrier observability composition, trigger registry contracts, and trigger authoring types |
| `@agent-os/runtime-protocol`             | yes       | runtime protocol       | runtime protocol vocabulary and pure projections only; runtime Effect services and control flow live in @agent-os/runtime                                                     |
...
| `@agent-os/backend-cloudflare-do`        | yes       | backend                | Cloudflare DO app facade, storage, alarm, SSE, dispatch, workspace-job response/profile composition, and binding materialization                                              |
...
| `@agent-os/resource-carrier`             | yes       | 0.4.x public           | provider-neutral resource lifecycle facts and symbolic proofs                                                                                                                 |
...
| `@agent-os/workspace-session`            | yes       | 0.4.x public           | provider-neutral workspace/session lifecycle facts                                                                                                                            |
| `@agent-os/workspace-op`                 | yes       | 0.4.x public           | workspace operation request/completion/rejection fact vocabulary and external-receipt settlement                                                                              |
...
| `@agent-os/workspace-env-cloudflare`     | yes       | 0.4.x public           | structural Cloudflare Sandbox-compatible fs+exec actuator adapter                                                                                                             |
| `@agent-os/workspace-env-local`          | yes       | 0.4.x public           | Node fs and shell calls bound to one explicit host workspace root                                                                                                             |
| `@agent-os/tenant-material`              | yes       | 0.4.x experimental     | encrypted credential records to execution-time material                                                                                                                       |
| `@agent-os/llm-transport-http`           | yes       | 0.4.x experimental     | HTTP provider deltas to non-durable turn frames                                                                                                                               |
| `@agent-os/llm-transport-effect-ai`      | yes       | 0.4.x experimental     | agentOS LlmRoute/material/tool/output algebra to Effect AI LanguageModel calls                                                                                                |
| `@agent-os/attached-stream`              | yes       | 0.4.x experimental     | runtime-neutral attached stream frame algebra; no ledger truth ownership                                                                                                      |
| `@agent-os/turn-stream`                  | yes       | 0.4.x public           | token/progress frame algebra                                                                                                                                                  |
| `@agent-os/workspace-env`                | yes       | 0.4.x public           | runtime-neutral WorkspaceEnv actuator; no ledger fact ownership                                                                                                               |
| `@agent-os/ag-ui`                        | yes       | 0.4.x public           | framework-neutral AG-UI edge protocol frames derived from typed runtime events and AgentSchema tool projections                                                               |
| `@agent-os/ag-ui-react`                  | yes       | 0.4.x public           | React hooks and stores over @agent-os/ag-ui frames; no runtime event parsing                                                                                                  |
| `@agent-os/ag-ui-svelte`                 | yes       | 0.4.x public           | Svelte stores over @agent-os/ag-ui frames; no runtime event parsing                                                                                                           |
| `@agent-os/run-stream`                   | yes       | 0.4.x public           | ledger/turn/submit-result composition                                                                                                                                         |
| `@agent-os/workspace-binding`            | yes       | 0.4.x public           | run-scoped submit bindings over workspace-env tools and material refs; no diagnostics, path policy, or effectful executor                                                     |
| `@agent-os/sse-http`                     | yes       | 0.4.x experimental     | HTTP Response and stream lifecycle wrappers over composer-owned frame codecs                                                                                                  |
| `@agent-os/decision-gate`                | yes       | 0.4.x public           | durable decision request/decision/consumption facts                                                                                                                           |
...
MCP registry support is not part of the 0.4.x surface; it remains a hold until discovery, install, authority, and material contracts converge across products.
