...
| `@agent-os/runtime`                      | yes       | 0.2.x public           | backend-neutral runtime Tag contracts, service implementations, projections, cross-carrier observability composition, trigger registry contracts, and trigger authoring types |
...
| `@agent-os/workspace-op`                 | yes       | 0.2.x public           | workspace operation request/completion/rejection fact vocabulary and external-receipt settlement                                                                              |
...
| `@agent-os/llm-transport-effect-ai`      | yes       | 0.2.x experimental     | agentOS LlmRoute/material/tool/output algebra to Effect AI LanguageModel calls                                                                                                |
...
| `@agent-os/ag-ui`                        | yes       | 0.2.x public           | framework-neutral AG-UI edge protocol frames derived from typed runtime events and AgentSchema tool projections                                                               |
...
| `@agent-os/workspace-binding`            | yes       | 0.2.x public           | run-scoped submit bindings over workspace-env tools and material refs; no diagnostics, path policy, or effectful executor                                                     |
