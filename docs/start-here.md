...
| ----------------------------------------- | --------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `recipe.natural-language-workspace-agent` | [Build a natural-language workspace agent](guides/build-natural-language-workspace-agent.md)  | `primitive.agent-authoring.compileAgentTree`, `primitive.agent-authoring.linkWorkspaceStaticTarget`, `primitive.workspace-agent.createWorkspaceAgentClient` |
