...
export const agentOsSourceAliasSpecs = [
  ...
  ["@agent-os/kernel/agent-schema", "packages/kernel/src/agent-schema.ts"],
  ["@agent-os/kernel/authored-value", "packages/kernel/src/authored-value.ts"],
  ...
  ["@agent-os/llm-protocol", "packages/llm-protocol/src/index.ts"],
  ["@agent-os/telemetry-protocol", "packages/telemetry-protocol/src/index.ts"],
  ["@agent-os/runtime-protocol", "packages/runtime-protocol/src/index.ts"],
  ...
  ["@agent-os/telemetry-otlp", "packages/wire-adapters/telemetry-otlp/src/index.ts"],
  ...
  ["@agent-os/client", "packages/client/core/src/index.ts"],
  ["@agent-os/client-react", "packages/client/react/src/index.ts"],
  ["@agent-os/client-svelte", "packages/client/svelte/src/index.ts"],
