...
export const agentOsSourceAliasSpecs = [
  ...
  ["@agent-os/ag-ui", "packages/composers/ag-ui/src/index.ts"],
  ["@agent-os/ag-ui-react", "packages/composers/ag-ui-react/src/index.ts"],
  ["@agent-os/ag-ui-svelte", "packages/composers/ag-ui-svelte/src/index.ts"],
