...
const generator = read("tooling/agentos-cli/src/generate/generate-carrier-reference.mjs");
failMatches("tooling/agentos-cli/src/generate/generate-carrier-reference.mjs", generator, [
  {
