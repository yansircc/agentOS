...
if (!exists("docs/reference/carriers.md")) {
  ...
  !read("docs/reference/carriers.md").includes(
    "generated by tooling/agentos-cli/src/generate/generate-carrier-reference.mjs",
  )
) {
...
for (const file of agentGeneratedMarkdownFiles) {
  ...
  const text = read(file);
  if (!text.includes("generated by tooling/agentos-cli/src/generate/generate-agent-docs.mjs")) {
...
for (const file of agentGeneratedJsonFiles) {
  ...
  if (json.generatedBy !== "tooling/agentos-cli/src/generate/generate-agent-docs.mjs") {
    failures.push(
      `${file} missing generatedBy tooling/agentos-cli/src/generate/generate-agent-docs.mjs`,
    );
  }
...
if (!exists("AGENTS.md")) {
  ...
  if (
    !agentsText.includes("generated by tooling/agentos-cli/src/generate/generate-agent-docs.mjs")
  ) {
...
for (const file of walk(path.join(root, "tooling/docs-site/src/content/docs"))
  ...
  const text = read(file);
  if (!text.includes("generated by tooling/agentos-cli/src/generate/project-docs-site.mjs")) {
