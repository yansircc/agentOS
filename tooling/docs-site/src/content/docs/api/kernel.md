---
title: "@agent-os/kernel Public API Intent"
---

<!-- generated by scripts/project-docs-site.mjs; edit docs/api/kernel.md -->
...
- `./llm:LlmMessage`
- `./llm:LlmOutputItem`
- `./llm:LlmOutputItemSchema`
- `./llm:LlmRequest`
- `./llm:LlmResponse`
- `./llm:LlmRoute`
- `./llm:LlmToolCall`
- `./llm:LlmToolCallSchema`
- `./llm:LlmUsage`
- `./llm:LlmUsageSchema`
- `./llm:OpenAIChatCompatibleRoute`
- `./llm:STRUCTURED_OUTPUT_TOOL_NAME`
- `./llm:ToolDefinition`
