...
| ----------------------------------------- | -------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------- |
| `recipe.natural-language-workspace-agent` | [Build a natural-language workspace agent](/guides/quickstart-node/)                         | `primitive.agent-authoring.compileAgentTree`, `primitive.agent-authoring.linkWorkspaceStaticTarget`                                    |
