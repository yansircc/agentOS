...
<!-- generated by packages/cli/src/generate/project-docs-site.mjs; edit docs/start-here.md -->
...
| ----------------------------------------- | -------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------- |
| `recipe.natural-language-workspace-agent` | [Build a natural-language workspace agent](/guides/build-natural-language-workspace-agent/)  | `primitive.agent-authoring.compileAgentTree`, `primitive.agent-authoring.linkWorkspaceStaticTarget`                                    |
...
| `recipe.durable-external-effect`          | [Compose a durable external effect](/tutorials/durable-external-effect/)                     | `primitive.kernel.EffectClaim`, `primitive.kernel.BoundaryContract`, `primitive.runtime.Ledger`                                        |
