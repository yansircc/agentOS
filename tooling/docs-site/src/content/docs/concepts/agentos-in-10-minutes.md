---
title: "agentOS In 10 Minutes"
slug: "concepts/agentos-in-10-minutes"
---

<!-- generated by packages/cli/src/generate/project-docs-site.mjs; edit docs/concepts/agentos-in-10-minutes.md -->
...
[Start Here](/start-here/) routes intent to recipes, primitives, errors, and
...
1. Pick a generated recipe id from [Start Here](/start-here/).
...
- [Agent error catalog](/agent/errors/)
- [Agent invariant matrix](/agent/invariant-matrix/)
- [Durable truth](/concepts/durable-truth/)
- [Materialized projections](/concepts/materialized-projections/)
- [AG-UI wire adapter](/concepts/ag-ui-wire-adapter/)
