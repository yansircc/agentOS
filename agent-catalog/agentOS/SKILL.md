---
name: agentOS
description: Generated installed catalog for agentOS 0.5.23 public packages, API intent, agent navigation, invariants, errors, and provenance.
---

# agentOS

This catalog is generated for `@yansirplus/cli` 0.5.23. Treat files under `references/` as installed-version facts; do not infer future API from chat context, archived CST events, or source checkouts.
