...
| `@agent-os/client`  | transport-neutral agent client store, decoded runtime ledger stream adapter, typed command surface, and optional framework subpath bridges                                                                                                        |
